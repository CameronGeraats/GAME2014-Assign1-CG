...
public class BulletManager : MonoBehaviour
{
    ...
    public GameObject GetBullet(Vector3 position, string name)
    {
        var newBullet = m_bulletPool.Dequeue();
        newBullet.SetActive(true);
        newBullet.transform.position = position;
        newBullet.GetComponent<BulletController>().CreatorObject = name;
        return newBullet;
    }
    ...
    public void ReturnBullet(GameObject returnedBullet)
    {
        ...
        returnedBullet.GetComponent<BulletController>().CreatorObject = "";
